        ...
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                function buildNavigation(startPage) {
                    ...
                    for (var i = startPage; i < startPage + numberOfPageLinks; i++) {
                ...
                function navigate(topage) {
                    ...
                    var index = topage;
                    var mid = numberOfPageLinks / 2;
                    if (numberOfPageLinks % 2 > 0) mid = (numberOfPageLinks + 1) / 2;
                    var startIndex = 0;
                    if (topage >= 0 && topage < totalpages) {
                        if (topage >= mid) {
                            if (totalpages - topage > mid)
                                startIndex = topage - (mid - 1);
                            else if (totalpages > numberOfPageLinks)
                                startIndex = totalpages - numberOfPageLinks;
                        }
                ...
                function showRequiredButtons() {
                    if (totalpages > settings.length) {
                        ...
                        if (totalpages > settings.length && currentPage < (totalpages - (settings.length / 2))) {
                            if (!settings.controlsalways) {
                                btnLast.css('display', '');
                            }
                            else {
